This Repo doesn't contain any videos, only some templates in the images' folder. The two templates right in ./images/ are used, the ones in the folders can be used.
